...
<p align="center">
  <a href="https://github.com/step-security/xcresulttool/actions"><img alt="xcresulttool status" src="https://github.com/step-security/xcresulttool/workflows/build-test/badge.svg"></a>
</p>
...
Here is [an example result](https://github.com/step-security/xcresulttool-example/pull/2/checks?check_run_id=3954797886).
...
```yaml
- uses: step-security/xcresulttool@v1
  with:
